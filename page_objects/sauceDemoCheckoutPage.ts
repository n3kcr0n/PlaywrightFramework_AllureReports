...
export default class SauceDemoCheckoutPage{
    readonly checkoutStepTwoUrl:string ='https://www.saucedemo.com/v1/checkout-step-two.html'
    ...
    fillCheckoutInfo= async(firstName:string,lastName:string,postal:string)=>{
        ...
        await this.page.waitForURL(this.checkoutStepTwoUrl);
    }
}